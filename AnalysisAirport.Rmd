...
constantsWithoutSensorAirport = list(
  "airport-environment?" = "true", "dt" = dt, 
...
nl1@experiment <- experiment(
  ...
  idsetup = "setup", idgo = "move", metrics = outputs, variables = variables, constants = constantsSensorAirport,
...
nl2@experiment <- experiment(
  expname = "social-distance-indoor-simulation", outpath = getwd(), repetition = 1,
  idsetup = "setup", idgo = "move", metrics = outputs, variables = variables, constants = constantsWithoutSensorAirport,
  # output measured on every tick or on final tick only?
  tickmetrics = "false",
  runtime = 36000,
  evalticks = seq(36000),
